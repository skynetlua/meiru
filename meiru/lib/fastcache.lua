...
-- function Entry:loadValue(cache, ...)
-- 	if self.isLoadFaildTime then
-- 		local curTime = ticker()
-- 		if curTime < self.isLoadFaildTime then
-- 			return
-- 		end
-- 		self.isLoadFaildTime = nil
-- 	end
-- 	if not skynet then
-- 		self:request_value(cache, ...)
-- 	end
...
-- 		-- 	self:resetEmpty()
-- 		-- end
-- 		-- local value = cache.loader:getValue(self.key, ...)
-- 		-- if not value then
-- 		-- 	self.isLoadFaildTime = ticker()+3600
-- 		-- 	self.value = nil
-- 		-- 	self.accessTime = 0
-- 		-- 	return
-- 		-- end
...
-- 	else
-- 		if not self.waitLoadThreads then
...
-- 		self.curThread = thread
-- 	end
-- 	if self.waitLoadThreads then
-- 		local nextThread = table.remove(self.waitLoadThreads, 1)
-- 		if nextThread then
-- 			skynet.wakeup(nextThread)
-- 		end
-- 	end
-- 	self.curThread = nil
-- 	return true
