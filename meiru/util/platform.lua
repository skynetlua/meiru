...
local mysqlcached = include(".db.mysqlcached", ...)
...
local database = {
	...
	gets    = mysqlcached.gets,
	get     = mysqlcached.get,
	fields  = mysqlcached.fields,
	insert  = mysqlcached.insert,
	update  = mysqlcached.update,
	updates = mysqlcached.updates,
	clear   = mysqlcached.clear,
	remove  = mysqlcached.remove,
	removes = mysqlcached.removes,
	delete  = mysqlcached.delete,
	deletes = mysqlcached.deletes,
}
